...
using System.Text;
using MrTe.Net.Dns.DynamicUpdate;
...
namespace MrTe.Net.Dns
{
	...
	public class DnsClient : DnsClientBase
	{
		...
		///   <see
		///     cref="MrTe.Net.Dns.DnsClient.BeginResolve" />
		///   .
		/// </param>
		/// <returns> The complete response of the dns server </returns>
		...
		///   An <see cref="System.IAsyncResult" /> object returned by a call to
		///   <see
		///     cref="MrTe.Net.Dns.DnsClient.BeginSendMessage" />
		///   .
		/// </param>
		/// <returns> The complete response of the dns server </returns>
		...
		///   An <see cref="System.IAsyncResult" /> object returned by a call to
		///   <see
		///     cref="MrTe.Net.Dns.DnsClient.BeginSendUpdate" />
		///   .
		/// </param>
		/// <returns> The complete response of the dns server </returns>
